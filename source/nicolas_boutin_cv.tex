...
\name{Nicolas}{BOUTIN}
\title{Ingénieur logiciel embarqué\newline \large \anneesExperience\ ans d'expérience} % base date 2011/10
...
\cvline{Système embarqué}{STM32, ARM M3-M4, RH-850, FreeRTOS, RL-RTX, Bootloader, UART, SPI, I2C, RTC, PWM, DLT, GDCN, Segger emWin, emFile, emUSB}
\cvline{Linux embarqué}{User-Space, Yocto, bitbake, SystemV, IPC, DBus, CommonAPI, sqlite3}
\cvline{Test-Intégration}{GoogleTest, GoogleMock, Python unittest, Cppcheck, Travis CI, Jenkins, Catch2, Parasoft}
\cvline{Management}{Pilotage d'équipe, Cycle en V}
\cvline{Logiciel/IDE}{Git, Perforce, SVN, VSCode, Eclipse, IAR, Keil uVision, STM32CubeMX, JIRA, Confluence, Bitbucket, DOORS, Bureautique, LaTeX}
...
% 2024/02 - ...
\cventry{2024}{Ingénieur logiciel embarqué}{easyLi, Groupe Manitou}{Chasseneuil-du-Poitou(86)}
	{Cycle en V logiciel (Spécification, architecture, construction, tests) pour des systèmes de batteries (BMS). Architecture, construction de logiciels outil de diagnostic débarqué en Python.}
	{ARM Cortex, C99, CAN, AFE, STM32Cube suite, Python}

% Avril 2022 - 2024/02
\cventry{2022--2024\newline2 ans}{Ingénieur logiciel Microcontrôleur}{Groupe Creative Rennes pour Marelli}{Châtellerault(86)}
	{Architecture, Développement et Tests composant logiciel embarqué en C. Architecture et Développement outils débarqués pour banc de test en Python. Migration système de compilation depuis Makefile vers CMake}
