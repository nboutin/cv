...
\usepackage{cv_fonctions} % for \anneesExperience and \monAge macros
...
\name{Nicolas}{BOUTIN}
% \title{Ingénieur logiciel embarqué\newline \large 13 années d'expériences} % base date 2011/10
\title{Architecte Système \& Logiciel Embarqué\newline \large \anneesExperience\ ans d'expérience -- Électronique, Capteurs \& IVV}
\address{4 Rue du Chausseur}{86110 Amberre}
\phone[mobile]{06~79~37~39~00}
\email{boutwork@gmail.com}
%\homepage{www.pierredurand.com}
\social[linkedin]{nicolas-boutin-111b9011b}
%\social[twitter]{pierre.durand}
%\social[github]{pierre.durand}
\extrainfo{26/04/1986, \monAge\ ans}
...
\cvline{Ingénierie Système}{Architecture produit, spécification, IVV, résolution de faits techniques complexes, interface HW/SW}
\cvline{Logiciel}{Architecture, Conception et Développement, Test Unitaire et Intégration}
\cvline{Programmation}{C99, C++03/11/14/17/20/23, Python3, CMake, Doxygen}
\cvline{Système embarqué}{STM32, ARM M3-M4, RH-850, FreeRTOS, RL-RTX, Bootloader, RTC, PWM, DLT, Segger emWin, emFile, emUSB}
\cvline{Protocole}{CAN UDS/J1939, UART, SPI, I2C, GDCN}
\cvline{Linux embarqué}{User-Space, Yocto, bitbake, SystemV, IPC, DBus, CommonAPI, sqlite3}
\cvline{IVV}{GoogleTest/Mock, Intégration Continue, Python unittest, Cppcheck, Jenkins, Catch2, Parasoft}
\cvline{Management}{Pilotage d'équipe, Cycle en V}
\cvline{Logiciel/IDE}{Git, VSCode, Eclipse, IAR, Keil uVision, STM32CubeMX, Azure DevOps, Redmine, JIRA, Confluence, Bitbucket, DOORS, Bureautique, LaTeX}
\cvline{Modélisation}{UML, Design pattern}
\cvline{Anglais}{Pratique et usage professionnel, TOEIC 895}
...
% 2024/02 - ...
\cventry{2024}{Architecte logiciel embarqué}{easyLi, Groupe Manitou}{Chasseneuil-du-Poitou(86)}
	{Cycle en V logiciel (Spécification, architecture, construction et tests) pour des systèmes de batteries (BMS). Environnement fortement contraint ISO-13849, CRA Cyber Resilient Act. Pilotage d'équipe de 2 ingénieurs. Architecture, construction de logiciels outils de diagnostics débarqués en Python.}
	{ARM Cortex, C/C++, CAN, AFE, STM32Cube suite, Microchip ATSAM, Python}

% Avril 2022 - 2024/02
\cventry{2019--2024\newline5 ans}{Architecte logiciel embarqué}{Groupe Creative Rennes pour Marelli}{Châtellerault(86)}
	{Architecture, Développement et Tests composants logiciels embarqué. Environnement fortement contraint ISO-26262. Architecture et Développement outils débarqués pour banc de test en Python. Migration système de compilation depuis Makefile vers CMake.}
	{ARM M23, C99, Python3, CMake, RL-RTX (RTOS), Keil uVision, GoogleTest/Mock}

% % 2019/02 - 2022/04
% \cventry{2019--2022\newline3 ans}{Ingénieur logiciel Microcontrôleur}{Groupe Creative Rennes pour Magneti Marelli}{Châtellerault(86)}
...
% Oct 2015 - Juil 2016
\cventry{2015--2016\newline10 mois}{Architecte logiciel embarqué}{Apside Rennes pour Canberra}{Loches(37)}
	{Définition et implémentation de l’architecture logicielle pour contaminamètre de chantier. Pilotage développement logiciel équipe 3 ingénieurs}
...
\cventry{2010--2011}{Apprenti par alternance}{ST-Ericsson}{Sophia-Antipolis (06)}
	{Conception et développement d’un système de diagnostic matériel pour ARM9 embarqué dans les téléphones}
...
\cventry{2005--2007}{Diplôme DUT GEII Génie Électrique et Informatique Industrielle}{Université Angers}{Angers(49)}{}{}
\cventry{2004--2005}{Baccalauréat STI Génie Électronique}{St-Julien-la-Baronnerie}{Angers(49)}{}{}

\section{Centres d'intérêt}

\cvitem{Sports}{Trail/Course nature, Voile, Badminton, Solex}
\cvitem{Lecture}{Actualités technologiques, scientifiques, robotiques et spatiales}
